...
一个可运行的 Atoms-like Demo，聚焦“描述应用 → 审批计划 → 智能体构建 → 应用预览/可视编辑 → 发布”的完整产品主线。

> 非官方项目，与 Atoms 无隶属关系。智能体和发布由本地规则模拟，不调用真实模型或云资源。
...
首次打开会加载一个完成构建的演示项目。新建项目可体验完整的计划审批与构建流程。
...
本仓库使用 GitHub Actions 自动发布 `site/` 到 GitHub Pages。
